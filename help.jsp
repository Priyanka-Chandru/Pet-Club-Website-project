...
<body>
 ...
 %>
	...
	<div class="page-head">
		<div class="container">
		<h3>Contact </h3>
		<img class="img-responsive" src="https://cdn.pixabay.com/photo/2016/09/01/19/53/pocket-watch-1637396__480.jpg"
					alt="Dummy Image"  />
		...
		<div class="container">
			...
			<div>
				<h4 class="section-subheading" align="left">
					<i class='fas fa-user'>&nbsp;&nbsp;Priyanka C</i>
				</h4>
			</div>
			<div>
				<h4 class="section-subheading" align="left">
					<i class='fas fa-envelope'>&nbsp;&nbsp;priyankac@gmail.com.</i>
				</h4>
			</div>
			<div>
				<h4 class="section-subheading" align="left">
					<i class='fas fa-phone'>&nbsp;&nbsp;7276463516.</i>
				</h4>
			</div>
			<div>
